  ...
  return (
    <div>
      ...
      >
        ...
        <p>
          This website isn't financial advise, always do your own research, we
          cannot be held responsible for any kind of loss.
        </p>
        ...
        <p>Any coin can be listed in the top Promoted coins section</p>
        <p>These are paid advertisement</p>
        <p>These are not verified coins</p>
        <p>
          If we have reports of rugpulling or scamming we reserv the right to
          delist these coins as soon as we can from this section
        </p>
        <h1>Governing Law</h1>
        <p>
